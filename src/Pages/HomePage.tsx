  ...
  return (
    <div className='container mx-auto px-4'>
         <Card css=' lg:h-80 md:h-80'> 
          <img src={GifPlant} alt="GifPlant" className='rounded-xl md:h-full md:object-cover md:w-full lg:h-full lg:w-full lg:object-cover '/>
            <div className='text-white p-8 bottom-0 absolute'>
              <p className='font-inter font-extrabold text-3xl mb-2'>Leaf Up</p>
              <p className='font-inter font-semibold text-2xl w-52 md:w-full lg:w-full'>Prenez soin de vos plantes</p>
            </div>
         </Card>
      <div>
         ...
         <Card css='h-64 shadow-2xl  mb-12'> 
            <div className='text-black p-8 bottom-0 absolute'>
              <p className='text-base font-inter font-semibold w-48 mb-2 md:w-full lg:w-full'>Découvrez notre nouvelle serre connectée</p>
      ...
      <Card css=' h-72 shadow-2xl bg-primary_02'> 
            <div className='text-white p-8 top-0 absolute text-right '>
              <p className='text-base w-40 mb-6 font-inter font-semibold ml-32 md:w-full md:ml-0'>Vous disposez déjà de notre serre ? </p>
              <p className='text-xs mb-8'>Accédez dès maintenant à votre espace personnel afin de vous informer sur l’état de votre plante.</p>
              <div className='h-28'>
         ...
         <Card css=' h-72 shadow-2xl bg-white '> 
            <div className='text-black  top-0 absolute w-full'>
              <div className=' h-48 w-full relative'>
                <img src={Trick} alt="fdfdffd"  className=' h-48 w-full  object-cover rounded-md'/>
              <div className='absolute top-12 right-12 text-right text-3xl font-bold font-poppins w-36' >
                ...
                <div className='px-8 pt-2'>
                  <p className='font-poppins font-semibold '>Découvrez les Posts rédigés par nos utilisateurs</p>
                  <a href="#" className='underline underline-offset-4 text-right float-right'>En savoir plus</a>
                </div>
            </div>
         </Card>
